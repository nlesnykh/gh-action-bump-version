...
Toolkit.run(async (tools) => {
  ...
  const majorWords = process.env['INPUT_MAJOR-WORDING'] ? process.env['INPUT_MAJOR-WORDING'].split(',') : null
  const minorWords = process.env['INPUT_MINOR-WORDING'] ? process.env['INPUT_MINOR-WORDING'].split(',') : null
  const patchWords = process.env['INPUT_PATCH-WORDING'] ? process.env['INPUT_PATCH-WORDING'].split(',') : null
  const preReleaseWords = process.env['INPUT_PATCH-WORDING'] ? process.env['INPUT_RC-WORDING'].split(',') : null
